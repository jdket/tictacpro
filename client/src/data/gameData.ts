...
export const gameData = {
  "effects": [
    { "id":"e001","name":"Center Boost","type":"scoring","text":"Lines through center give +5 coins","value":5 },
    { "id":"e002","name":"Corner Bonus","type":"scoring","text":"+2 coins per corner used in a line","value":2 },
    { "id":"e003","name":"Edge Bonus","type":"scoring","text":"+1 coin per edge used in a line","value":1 },
    { "id":"e004","name":"Combo Counter","type":"scoring","text":"Each line this level raises a combo, each next line +3 coins","value":3 },
    { "id":"e005","name":"Diagonal Doubler","type":"scoring","text":"Diagonal lines pay x2","value":2 },
    { "id":"e006","name":"Row Runner","type":"scoring","text":"Horizontal lines +4 coins","value":4 },
    { "id":"e007","name":"Column Climber","type":"scoring","text":"Vertical lines +4 coins","value":4 },
    { "id":"e008","name":"Triple Cherry","type":"scoring","text":"If you make 3 lines this level, final payout x2","value":2 },
    { "id":"e009","name":"Perfect Fill","type":"scoring","text":"If the board fills this level, +8 coins","value":8 },
    { "id":"e010","name":"Quick Start","type":"scoring","text":"If your first move is center, +6 coins","value":6 },
    ...
    { "id":"e017","name":"Edge Magnet","type":"placement","text":"Your first X this level must be on an edge, +3 coins if a line happens","value":3 },
    { "id":"e018","name":"Corner Magnet","type":"placement","text":"Your first X this level must be on a corner, +3 coins if a line happens","value":3 },
    ...
    { "id":"e025","name":"Hide Corners","type":"memory","text":"Corners are dim this level, remember them for +3 coins on use","value":3 },
    { "id":"e026","name":"Hide Edges","type":"memory","text":"Edges are dim this level, remember them for +3 coins on use","value":3 },
    { "id":"e027","name":"Blink Board","type":"memory","text":"Board blinks for a moment after AI moves, plan ahead","value":1 },
    { "id":"e028","name":"Order Recall","type":"memory","text":"If you can name your last 3 moves in order, gain +5 coins","value":5 },
    ...
    { "id":"e041","name":"Bonus Bank","type":"economy","text":"Each line gives +2 extra coins this level","value":2 },
    { "id":"e042","name":"Streak Saver","type":"economy","text":"If you score in 2 turns in a row, +4 coins extra","value":4 },
    { "id":"e043","name":"Even Up","type":"economy","text":"If your line uses only even index cells, +5 coins","value":5 },
    { "id":"e044","name":"Odd Up","type":"economy","text":"If your line uses only odd index cells, +5 coins","value":5 },
    ...
    { "id":"e047","name":"Two Line Gift","type":"economy","text":"If you get exactly 2 lines this level, +6 coins","value":6 },
    { "id":"e048","name":"No Center Gift","type":"economy","text":"If you never use center, +8 coins","value":8 },
    { "id":"e049","name":"Corner Collector","type":"economy","text":"If all 4 corners are filled by end, +10 coins","value":10 },
    { "id":"e050","name":"Saver","type":"economy","text":"Adds +10% coins to end of game total","value":0.10 }
  ],
  "obstacles": [
    ...
    { "id":"o018","name":"Center Tax","text":"Placing on center removes 2 coins from this level payout","rule":"level penalty on center use" },
    { "id":"o019","name":"Edge Tax","text":"Placing on edges removes 1 coin from this level payout","rule":"level penalty on edge use" },
    { "id":"o020","name":"Corner Tax","text":"Placing on corners removes 1 coin from this level payout","rule":"level penalty on corner use" }
  ]
};
